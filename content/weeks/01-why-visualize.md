...
homework: Make your first visualization from a dataset you find or create
homework_ja: 見つけた、または作成したデータで最初の可視化をつくる
challenge: Your first visualization
challenge_ja: 最初の可視化
tools: Paper + any chart tool
tools_ja: 紙と任意のグラフ作成ツール
